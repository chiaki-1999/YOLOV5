...
def parse_args():
    ...
    parser.add_argument('--weights', default="cf9w_xupeng.pt", help='Input weights(.pt)filepath(required)')
    parser.add_argument('--output', default="cf9w_xupeng.wts", help='Output (.wts) filepath(optional)')
